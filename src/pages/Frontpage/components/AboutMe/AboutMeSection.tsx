...
const AboutMeSection: React.FC =() => {
  return (
    <>
      <p>
        Hey! My name is Matheus Kröning dos Santos and
        I am a systems developer. Lover of music, bikes,
        vintage cars and motorcycles. Black coffee worshiper.
      </p>
      <p>
        I live in the city of Pelotas / RS. Where I cultivate good friends and an amazing family.
      </p>
      <p>
